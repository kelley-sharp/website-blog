  ...
  return (
    ...
    >
      <div className="col-span-12 grid grid-cols-12 flex-col px-6 md:flex-row">
        <div className="col-span-12 flex w-full flex-col gap-20 text-xl md:col-span-7 md:text-2xl">
          <p>Welcome! 👋🏻</p>
          <p>
        ...
        <MyProfilePic className="col-span-12 hidden min-w-full md:col-span-5 md:block" />
      </div>
